...
# -----------------------------------------------------------------------
languages=factor(c("Bengali","Hindi","Hindi","Marathi",
                  "Tamil","Punjabi","Hindi","Marathi",
                  "Hindi","Hindi","Marathi","Marathi",
                  "Tamil","Bengali","Tamil","Punjabi",
                  "Tamil","Tamil","Tamil",
                  "Marathi","Marathi","Tamil","Bengali",
                  "Tamil","Hindi"))  
table(languages)                           # frequency table
addmargins(table(languages))
#########################################################################
# 3.b Variable Discrete
# -----------------------------------------------------------------------
siblings = c(0,2,2,1,1,1,1,3,0,0,2,1,1,0,2,3,1,4,1,2,2,0,1,0,0,1,3,0,1,1)
children = addmargins(table(siblings+1))
mean(siblings+1)            # A.M.
